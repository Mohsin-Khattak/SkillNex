...
const AIAnalyzer = () => {
    return (
        <View style={styles.container}>
            ...
            <Regular fontSize={12} color={'#8D8D8D'} label={'Process personalization'}/>
            {/* Insights Section */}
            <View style={styles.insightsContainer}>
                <Text style={styles.insightsTitle}>Insights</Text>
                <Text style={styles.subtitle}>Review Your Overall Performance</Text>
                {/* <View style={styles.audioVisualizer} /> */}
                <Image source={Voice} style={{ height: 50, width: '100%',marginBottom:10}} />
            ...
            {/* Buttons */}
            <View style={{ gap: 20 }}>
                <PrimaryButton textStyle={{ fontSize: 16 }} label="Recommended for Next Round" />
                <PrimaryButton textStyle={{ fontSize: 16 }} label="Apply For Another Evaluation" />
            </View>
        </View>
    );
};
