            ...
            <ScrollView contentContainerStyle={styles.contentContainerStyle}>
                ...
                <View style={styles.contentSection}>
                    ...
                    <View style={{...styles.rowContainer,paddingHorizontal:0}}>
                        ...
                        <View style={{ flex: 1, }}>
                            <Regular label={`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`} style={styles.description}>
                            </Regular>
                            <View style={styles.list}>
                                <Regular label={'• Work with the team to design and iOS mobile applications on Azure using Swift and Objective-C.'} style={styles.listItem}></Regular>
                                <Regular label={'• Understanding, assessing, analyzing user requirements and function specification.'} style={styles.listItem}></Regular>
                                <Regular label={'• Prepare detailed technical specification.'} style={styles.listItem}></Regular>
                            </View>
                        </View>
                    </View>
                    <View style={{...styles.rowContainer,paddingHorizontal:0}}>
                ...
                <View style={styles.buttonSection}>
                    <PrimaryButton label={'Recommended for Next Round'} textStyle={{ fontSize: 14 }} />
